...
for Total household / Split by person / Split by card, drawing one bar
per card or person. Filters change only what is displayed; the download
always writes every original row.
